        ...
        <div style={{ maxWidth: 760, margin: '0 auto', textAlign: 'center' }}>
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p style={{ fontFamily: 'Inter,sans-serif', fontSize: 17, color: '#6B7280', lineHeight: 1.8 }}>
              Wir suchen Partnerinnen and Partner mit unternehmerischem Denken, Qualitätsbewusstsein and dem Anspruch, ein Premium-Konzept professionell umzusetzen. Erfahrung in Gastronomie, Retail oder Standortentwicklung ist von Vorteil, aber nicht in jedem Fall Voraussetzung. Entscheidend sind Markenverständnis, Verlässlichkeit and langfristiges Engagement.
            </p>
          </motion.div>
        </div>
      </section>
