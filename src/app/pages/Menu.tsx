...
export function Menu() {
  ...
  const menuItems: MenuItem[] = [
    {
      id: 1,
      name: 'Classic Soufflé Stack',
      description: 'Three fluffy layers of heaven, served with maple syrup and butter',
      price: '€12.90',
      image: '/Menu (7).png',
      category: 'pancakes',
      bg: '#FEF3E2',
    ...
    },
    {
      ...
      description: 'Topped with fresh strawberries, whipped cream, and berry compote',
      price: '€14.50',
      image: '/Menu (8).png',
      category: 'pancakes',
      bg: '#FEF3E2',
    ...
    },
    {
      ...
      description: 'Premium matcha-infused pancakes with red bean paste',
      price: '€15.90',
      image: '/Menu (6).png',
      category: 'pancakes',
      bg: '#FCE8E8',
    ...
    },
    {
      id: 4,
      name: 'Caramel Dream',
      description: 'Rich caramel sauce, vanilla ice cream, and toasted nuts',
      price: '€16.50',
      image: '/Menu (5).png',
      category: 'pancakes',
      bg: '#FCE8E8',
    },
    {
      ...
      description: 'Belgian chocolate sauce, whipped cream, and chocolate shavings',
      price: '€15.50',
      image: '/Menu (9).png',
      category: 'pancakes',
      bg: '#FEF3E2',
    ...
    {
      id: 6,
      name: 'Seasonal Fruit Tower',
      description: 'Fresh seasonal fruits with honey drizzle and mint',
      price: '€14.90',
      image: '/Menu (10).png',
      category: 'pancakes',
      bg: '#FEF9E2',
    ...
    },
    {
      ...
      description: 'Tropical blend of mango and passion fruit',
      price: '€6.20',
      image: '/Menu (11).png',
      category: 'drinks',
      bg: '#FCE8E8',
    ...
    },
    {
      id: 10,
      name: 'Iced Hojicha',
      description: 'Refreshing roasted green tea over ice',
      price: '€5.50',
      image: '/Menu (2).png',
      category: 'drinks',
      bg: '#E8F5E2',
    ...
    },
    {
      ...
      description: 'Freshly baked daily - plain, almond, or chocolate',
      price: '€4.50',
      image: '/Menu.png',
      category: 'desserts',
      bg: '#FEF9E2',
